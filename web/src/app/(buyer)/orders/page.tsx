...
function OrderCard({ order, index }: { order: Order; index: number }) {
  ...
  return (
    <div
      className="bg-surface rounded-xl border border-border p-4 mb-3 hover:border-border-hover hover:shadow-warm transition-all animate-slide-up"
...
export default function OrdersPage() {
  ...
  return (
    <div className="px-5 pt-4">
      <h1 className="text-2xl font-serif text-text mb-5 animate-slide-up">Meus Pedidos</h1>
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 gap-3 animate-scale-in">
          ...
          <p className="text-text-muted text-sm">Faça seu primeiro pedido!</p>
        </div>
      ) : (
